...
$command = filter_input(INPUT_POST, "command") ? filter_input(INPUT_POST, "command") : filter_input(INPUT_GET, "command");
$command_parameter = filter_input(INPUT_POST, "command_parameter") ? filter_input(INPUT_POST, "command_parameter") : filter_input(INPUT_GET, "command_parameter");
if($command) {
    if($command === "group") {
